<template>
      ...
      <div v-else class="card">
        ...
        >
          ...
          <Column
            ...
            style="width: 20%"
          ></Column>
          <Column field="emergencyContact" header="Emergency Contact" style="width: 20%"></Column>
          <Column
  ...
  <UpdateEmployee v-if="modal_update" @close="modal_update = false" :data="selectedData"/>
